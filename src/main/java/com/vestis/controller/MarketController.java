...
public class MarketController {
	...
	public String modify(@ModelAttribute MarketVo marketVo, @RequestParam("currNo") int currNo,
			@RequestParam("kwd") String kwd) throws UnsupportedEncodingException {
