...
<script type="text/javascript"
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBJKNfD945xU1q-W9XikGXR5zNnas7fJLo"></script>
...
<link
	...
	rel="stylesheet">
<script
	src="${pageContext.request.contextPath}/assets/vendor/jquery/jquery.js"></script>
...
<script language="javascript" charset="UTF-8">
	function goPopup() {
		...
		var pop = window.open(
				"${pageContext.request.contextPath }/user/addressform", "pop",
...
<body>
	...
	<div class="container" id="about">
			...
			<div id="joinform" class="col-md-12">
				...
				<div class="table-responsive">
					<div class="col-md-12 container">
						<form id="forminf" class="form-signin" method="get"
							action="${pageContext.request.contextPath }/user/changeinfo"
							disabled>

							<div class="row">
								<div class="col-md-12">
									<label for="inputEmail" class="sr-only">Email address</label> <input
										type="hidden" id="inputEmail" name="email"
								...
								<table>
									<tr>
										<td><input type="text" style="width: 512px !important;"
											id="roadFullAddr" name="address" /> <span><input
												id="add" type="button" onClick="goPopup();" value="주소검색" /></span>
										</td>
									</tr>
									<tr>
										<!-- <td></td> -->
										<td><input type="hidden" style="width: 500px;" id="lat"
											value="${user.lat}" name="lat" /></td>
									</tr>
									<tr>
										<!-- <td></td> -->
										<td><input type="hidden" style="width: 500px;" id="lng"
											value="${user.lon}" name="lon" /></td>
									</tr>
								</table>
							</div>
								...
								<span id="profilenn" class='col-lg-9 col-sm-12 tb '>
									<div id="birth_form">
										<tr>
											...
											<td class="birth"><select id="birthyear"
												name="birthyear" class="MS_select MS_birthday">
											...
											</select>년<select id="birthmonth" name="birthmonth"
											...
											<c:choose>
												<c:when test="${sessionScope.authUser.gender=='female' }">
															<input id="gender" type="radio" name="gender" value="male"
																class="MS_radio">남 <input id="gender"
																type="radio" name="gender" value="female"
																class="MS_radio" checked="">여</td>
												</c:when>
												<c:otherwise>
													<input id="gender" type="radio" name="gender" value="male"
														class="MS_radio" checked="">남 <input id="gender"
														type="radio" name="gender" value="female" class="MS_radio">여</td>
												</c:otherwise>
											</c:choose>
										</tr>
									</div>
							...
							<form id="ffff" action="${pageContext.request.contextPath }/user/proimage" method="post" enctype="multipart/form-data">									
								<input type="file" id="images" name="file" onchange="preview_images();">
							</form>
		  		...
		  		<img  src="${pageContext.request.contextPath }/upload" class="imgSize" style="background-color: red; width: 100px; height: 100px; margin-bottom: 0px;">
							...
							<a href="${pageContext.request.contextPath }/user/modifyform"
								class="btn btn-lg btn-info btn-block" id="default">다시하기</a>
		...
		<%-- <div class="row tb" style="width: 100px; border: 1px;">
			<form id="ffff"
				action="${pageContext.request.contextPath }/user/proimage"
	 ...
	 <form id="passform" class="form-signin" method="post" action="${pageContext.request.contextPath }/user/changepass" disabled>
      ...
      --%>
		<form id="move" method="get"
			...
			<input id="mo" type="hidden"
				value="${sessionScope.authUser.profile_no}">
		</form>
